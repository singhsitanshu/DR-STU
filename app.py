...
products = [
    ...
    {'name': "Philly Dunks", "price": "35.99", "img":"/static/dunks/philly_dunks/philly_dunks.png", 'details' : ['/static/dunks/philly_dunks/phillydunksdetail/0.png', '/static/dunks/philly_dunks/phillydunksdetail/1.png', '/static/dunks/philly_dunks/phillydunksdetail/2.png', '/static/dunks/philly_dunks/phillydunksdetail/3.png'], "desc":"Paying homage to the Philadelphia Phillies, the Nike SB Dunk Low Philadelphia Phillies, boasts a Valor blue Durabuck and suede upper, Team Maroon Swooshes, and woven tongue labels with graphics depicting two Philly staples: the Liberty Bell and a Philly cheese steak sandwich. From there, a white and gum brown Nike Zoom sole completes the design. "},
    {'name' : 'Navy Dunks', 'price' : '35.99', 'img' : '/static/dunks/navy_dunks/navy_dunks.png', 'details' : ['/static/dunks/navy_dunks/navydunksdetail/0.png', '/static/dunks/navy_dunks/navydunksdetail/1.png', '/static/dunks/navy_dunks/navydunksdetail/2.png', '/static/dunks/navy_dunks/navydunksdetail/3.png'], 'desc' : 'Nodding to the aged appeal of vintage Nike Dunks, the women\'s Nike Dunk Low Vintage Navy (W) features a white leather upper with navy overlays and Swooshes. At the base, a yellowed midsole gives off an aged, worn-in feel. Woven Nike tongue labels and an embroidered Nike heel patch add the finishing touch to this retro design.'},

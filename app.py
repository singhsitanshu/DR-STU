...
products = [
    ...
    {'name' : 'Navy Dunks', 'price' : '35.99', 'img' : '/static/dunks/navy_dunks/navy_dunks.png', 'detail-imgs' : ['/static/dunks/navy_dunks/navydunksdetail/0.png', '/static/dunks/navy_dunks/navydunksdetail/1.png', '/static/dunks/navy_dunks/navydunksdetail/2.png', '/static/dunks/navy_dunks/navydunksdetail/3.png'], 'desc' : 'Nodding to the aged appeal of vintage Nike Dunks, the women\'s Nike Dunk Low Vintage Navy (W) features a white leather upper with navy overlays and Swooshes. At the base, a yellowed midsole gives off an aged, worn-in feel. Woven Nike tongue labels and an embroidered Nike heel patch add the finishing touch to this retro design.'},
